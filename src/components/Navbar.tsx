...
function Navbar() {
    return (
        <div className="bg-white py-4 px-4 md:px-10 lg:px-24 border-b border-black flex items-center justify-between">
            ...
            <div
                className="hidden sm:flex gap-2 border border-black p-2 rounded-lg hover:bg-black hover:text-white hover:cursor-pointer hover:rounded-none transition-all"
